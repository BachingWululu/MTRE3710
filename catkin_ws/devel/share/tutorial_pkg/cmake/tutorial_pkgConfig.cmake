...
if("TRUE" STREQUAL "TRUE")
  set(tutorial_pkg_SOURCE_PREFIX /home/pierceboerner/catkin_ws/src/tutorial_pkg)
  set(tutorial_pkg_DEVEL_PREFIX /home/pierceboerner/catkin_ws/devel)
  ...
  set(tutorial_pkg_INSTALL_PREFIX /home/pierceboerner/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tutorial_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pierceboerner/catkin_ws/src/tutorial_pkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pierceboerner/catkin_ws/devel/lib;/opt/ros/melodic/lib)
